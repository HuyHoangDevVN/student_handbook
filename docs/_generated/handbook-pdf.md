...
2. Quickstart
3. Sample project
4. Checklist sinh viên mới
5. Tổng quan
6. Điều hướng terminal
7. Quản lý file
8. Pipe và redirect
9. Tìm kiếm và biến môi trường
10. Tổng quan
11. Cài đặt WSL
12. Package và permissions
13. Process và network
14. Systemd và services
15. VS Code
16. Tổng quan
17. Git fundamentals
18. Branching, merge, rebase
19. Undo và recovery
20. GitHub Workflow
21. Python & Anaconda
22. Node.js & npm
23. Quản lý Dependencies
24. HTTP & REST API
25. API Testing
26. Tổng quan
27. Cài đặt PostgreSQL
28. SQL CRUD cơ bản
29. Index, transaction, tối ưu
30. MongoDB & Redis
31. Tổng quan
32. Docker runtime
33. Debug, logs, storage
34. Dockerfile và build workflow
35. Docker Compose
36. Tổng quan
37. CI/CD fundamentals
38. CI cho Node.js và Python
39. Secrets, release, debug
40. Deployment cơ bản
...
```markdown
*Hình minh họa được lược bỏ trong bản PDF: CI.*
```
